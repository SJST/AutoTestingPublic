...
zzmk_django_logs_dir_path = 'F:\\eclipse-workspace\\zzmk_django_logs'

#    开发服务器盘符
zzmk_django_logs_dir_path = 'F:\\eclipse-workspace\\zzmk_django_logs'

if not os.path.exists(zzmk_django_logs_dir_path):
    #    上线服务器盘符
    zzmk_django_logs_dir_path = 'D:\\eclipse-workspace\\zzmk_django_logs'
